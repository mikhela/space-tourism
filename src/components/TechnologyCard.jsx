        ...
        <div className='animationtech-left flex justify-between flex-wrap'>
            <div className="flex items-center gap-6 lg:gap-12 w-[450px] mx-auto">
               ...
               {Object.keys(technologies).map((key) => (
                ...
                <h1 className="font-bellefair md:text-5xl mt-3 text-3xl text-white">{technologies[technoActive].name}</h1>
            ...
            <div className="animationtech right-content-technology mt-8 mx-auto mb-12">
                ...
                <img src={technologies[technoActive].image} alt={technologies[technoActive].name} className="w-full h-auto mt-8" />
            </div>
        </div>
    )
}
